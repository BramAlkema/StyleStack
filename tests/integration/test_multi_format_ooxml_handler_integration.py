#!/usr/bin/env python3
"""
Integration Tests for multi_format_ooxml_handler

This module contains integration tests for the multi_format_ooxml_handler module,
...
class TestMultiFormatOoxmlHandlerIntegration:
    """Integration tests for multi_format_ooxml_handler module."""
