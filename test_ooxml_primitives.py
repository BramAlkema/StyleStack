...
def test_powerpoint_primitives():
    ...
    # Test template path
    template_path = Path("tests/integration/fixtures/templates/test_presentation.potx")
...
def test_word_primitives():
    ...
    template_path = Path("tests/integration/fixtures/templates/test_document.dotx")
    if not template_path.exists():
        print(f"❌ Template not found: {template_path}")
        return False
...
def test_excel_primitives():
    ...
    template_path = Path("tests/integration/fixtures/templates/test_workbook.xltx")
    if not template_path.exists():
        print(f"❌ Template not found: {template_path}")
        return False
